...
================================================================================
BENCHMARK SUMMARY: naive_attention_forward (tiled memory) + softmax
================================================================================

Config                         PyTorch (ms)    CUDA (ms)       Speedup
--------------------------------------------------------------------------------
B1_H4_T8_D16                   0.0409          0.0261          1.57      x
B2_H6_T49_D32                  0.0393          0.0270          1.45      x
B4_H12_T343_D32                0.2968          0.4865          -1.64     x
B8_H24_T343_D32                1.2052          2.3048          -1.91     x
================================================================================

================================================================================
BENCHMARK SUMMARY: naive_attention_forward (tiled memory) + softmax + @ value
================================================================================

Config                         PyTorch (ms)    CUDA (ms)       Speedup
--------------------------------------------------------------------------------
B1_H4_T8_D16                   0.0641          0.0360          1.78      x
B2_H6_T49_D32                  0.0694          0.0403          1.72      x
B4_H12_T343_D32                0.4103          0.6732          -1.64     x
B8_H24_T343_D32                1.6439          3.2454          -1.97     x
================================================================================
...
````
================================================================================
BENCHMARK SUMMARY (PyTorch's Built-in SDPA, Flash Attention when available)
================================================================================

Config                         PyTorch (ms)    CUDA (ms)       Speedup
--------------------------------------------------------------------------------
B1_H4_T8_D16                   0.0511          0.0213          2.40      x
B2_H6_T49_D32                  0.0632          0.0234          2.70      x
B4_H12_T343_D32                0.4227          0.2773          1.52      x
B8_H24_T343_D32                1.6606          0.9224          1.80      x
================================================================================
````
